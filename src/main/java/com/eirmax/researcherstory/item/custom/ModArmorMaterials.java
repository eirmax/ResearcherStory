...
public enum ModArmorMaterials implements ArmorMaterial {
    RESEARCHER_ARMOR("researcher_armor", 24, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 4);
        p_266655_.put(ArmorItem.Type.HELMET, 5);
    }), 5, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.of(Items.IRON_INGOT));
    ...
    public String getName() {
        return ResearcherStory.MODID + ":" + this.name;
    }
